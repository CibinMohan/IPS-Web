                ...
                <header>
                        ...
                        <nav>
                            <ul id="menu">
                                ...
                                <li id="menu_active" class="bg_none">
                                    <a href="ViewReportCourt.jsp">View Report</a></li>
                    ...
                    <div class="wrapper">
                        <article class="col1 pad_left2">
                            ...
                            <p>Traffic officers are usually assigned to work in the department
                                and receive all the same law enforcement training and
                                instruction that other members of the force undertake.
                                They also carry a firearm, baton and all other standard police supplies.
                            </p>
                        </article>
                    </div>
                </header>
