                ...
                <header>
                    ...
                    <div class="wrapper">
                        <article class="col1 pad_left2">
                            ...
                            <p><span class="marg_top">The initial duties and responsibilities of early law
                                    enforcement officials in The Bahamas were extremely vast,
                                    a fact that is rather unusual by present day standards.</span>
                            </p>
                        </article>
                    </div>
                </header>
                ...
                <article class="pad_left2">
                    ...
                    <form name="form1" id="form1" method="post" action="SetPanalty?id=<%=case_id%>&type=<%=loginBean.getUserType()%>">
                        <ul id="form_fields"><li>
                            ...
                            <li><input type="text" name="status" id="status" onKeyDown="return isLetters(event)" required  /> </li-->
